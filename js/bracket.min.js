/* jQuery Bracket | Copyright (c) Teijo Laine 2011-2013 | Licenced under the MIT licence */ ! function(a) {
    ...
    var v = function(e) {
            ...
            function i(c, d, i, j, k) {
                ...
                return o.a.id = 0, o.b.id = 1, o.a.name = o.a.source ? o.a.source().name : null, o.b.name = o.b.source ? o.b.source().name : null, o.a.score = j ? j[0] : null, o.b.score = j ? j[1] : null, o.a.name && o.b.name || !b(o.a.score) && !b(o.b.score) || (console.log("ERROR IN SCORE DATA: " + o.a.source().name + ": " + o.a.score + ", " + o.b.source().name + ": " + o.b.score), o.a.score = o.b.score = null), {
                    el: r,
                    id: i,
                    round: function() {
                        return c
